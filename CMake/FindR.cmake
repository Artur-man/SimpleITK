...
if(WIN32)
  list(APPEND _R_WINDOWS_HINTS "[HKEY_CURRENT_USER\\Software\\R-core\\R;InstallPath]/bin/x64")
  list(APPEND _R_WINDOWS_HINTS "[HKEY_LOCAL_MACHINE\\Software\\R-core\\R;InstallPath]/bin/x64")
  list(APPEND _R_WINDOWS_HINTS "[HKEY_CURRENT_USER\\Software\\R-core\\R;InstallPath]/bin")
  list(APPEND _R_WINDOWS_HINTS "[HKEY_LOCAL_MACHINE\\Software\\R-core\\R;InstallPath]/bin")
endif()
...
find_program(RSCRIPT_EXECUTABLE Rscript HINTS ${R_HOME} ${_R_WINDOWS_HINTS} DOC "Rscript executable.")
...
if(MINGW)
  ...
  list(APPEND _R_LIBRARY_PATH_SUFFIXES /bin /bin/x64)
endif()

find_library(R_LIBRARY_BASE R PATHS ${R_HOME} PATH_SUFFIXES ${_R_LIBRARY_PATH_SUFFIXES} DOC "R library (example libR.a, libR.dylib, R.dll, etc.).")
